...
class About:
    ...
    def show_about(root):
        ...
        title = ttk.Label(about_dialog, text='STL to GCode Converter', font=('Helvetica', 16, 'bold'))
        title.pack(pady=20)
        ...
        description = ttk.Label(about_dialog, text='A simple STL to GCode Converter.', justify=tk.CENTER)
